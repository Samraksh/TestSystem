    ...
    public class GDB
    {
		...
		*/
		...
		public void Start()
		{
            ...
            startInfo.FileName = @"D:\Work\SamTest\codesourcery\bin\arm-none-eabi-gdb.exe";
        ...
        public void Init()
        {
            axf = @"D:\MicroFrameworkPK_v4_0\BuildOutput\THUMB2\GCC4.2\le\FLASH\debug\STM32F10x\bin\RegressionTest.axf";
        }
