...
namespace TestRig
{
    public class msbuild
    {
        ...
        public string mfInstalltionPath;
        ...
        public string codeSourceryPath;
		...
		*/
        ...
        public void Init(string rootPath, string testProjName, string codeSourceryPath, string mfInstallationPath)
        {
            this.rootPath = rootPath;
            this.testProjName = testProjName;
            this.codeSourceryPath = codeSourceryPath;
            this.mfInstalltionPath = mfInstallationPath;
        }
