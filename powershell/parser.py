...
class Parser:
	...
	def __init__(self,filename):
		self.tokenizerObject = Tokenizer(filename)
	...
	def parseInclude(self,filename):
		#print(filename)
		self.includeTokenizerObject = Tokenizer(filename)
...
if  __name__ == "__main__":
	parserObject = Parser("timers.edf")
